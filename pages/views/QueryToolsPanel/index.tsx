...
const QueryToolsPanel: FC<{}> = observer(() => {
  ...
  return (<div className={styles["queryTools"]}>
    ...
    <Button className={styles["button"]} disabled={ !dataStore.selectedDatasetName } type={queryMode === "vtt" ? "primary" : "default"} >VTT</Button>
    <Button className={styles["button"]} disabled={ !dataStore.selectedDatasetName } type={queryMode === "sketch" ? "primary" : "default"} >sketch</Button>
    <Button className={styles["button"]} disabled={ !dataStore.selectedDatasetName } type={queryMode === "knn" ? "primary" : "default"} >KNN</Button>
    <Button className={styles["button"]} disabled={ !dataStore.selectedDatasetName } type={queryMode === "rnn" ? "primary" : "default"} >RNN</Button>
